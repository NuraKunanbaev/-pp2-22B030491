...
pencil = Button(1, "TSIS9\paint\pencil.png", 850, 5)
eraser = Button(1, "TSIS9\paint\eraser.png", 835, 150)
randomizer = Button(4, 'TSIS9\paint\erand.png', 1300, 160)
rec = Button(2, None, 820, 280)
cir = Button(3, None, 910, 280)

buttons = pygame.sprite.Group()
# Добавление случайных цветов
